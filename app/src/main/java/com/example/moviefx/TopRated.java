...
public class TopRated extends AppCompatActivity implements AdapterLists.OnMovieListener{
    ...
    private static String JSON_URL_TOP= "https://api.themoviedb.org/3/movie/top_rated?api_key=007d372694c979392339b81489989b16";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchBarIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                intent = new Intent(TopRated.this, Search.class);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id)
                {
                    ...
                    case R.id.nav_location:
                        intent = new Intent(TopRated.this, Map.class);
                        startActivity(intent);
                        break;
                    case R.id.logout:
